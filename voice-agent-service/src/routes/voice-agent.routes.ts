...
import { VoiceAgentController } from '../controllers/voice-agent.controller';
...
async function voiceAgentRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.createVoiceAgent(request as any, reply);
    }
  });
  ...
  fastify.get('/', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.getVoiceAgents(request as any, reply);
    }
  });
  ...
  fastify.get('/:agentId', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.getVoiceAgent(request as any, reply);
    }
  });
  ...
  fastify.put('/:agentId', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.updateVoiceAgent(request as any, reply);
    }
  });
  ...
  fastify.delete('/:agentId', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.deleteVoiceAgent(request as any, reply);
    }
  });
  ...
  fastify.post('/:agentId/deploy', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.deployAgent(request as any, reply);
    }
  });
  ...
  fastify.post('/:agentId/stop', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.stopAgent(request as any, reply);
    }
  });
  ...
  fastify.post('/:agentId/test', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.testAgent(request as any, reply);
    }
  });
  ...
  fastify.get('/:agentId/metrics', {
    ...
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.getAgentMetrics(request as any, reply);
    }
  });
  ...
  fastify.get('/sessions/active', {
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.getActiveSessions(request as any, reply);
    }
  });
  ...
  fastify.get('/workers/stats', {
    handler: async (request, reply) => {
      const controller = (fastify as any).voiceAgentController as VoiceAgentController;
      return controller.getWorkerStats(request as any, reply);
    }
  });
